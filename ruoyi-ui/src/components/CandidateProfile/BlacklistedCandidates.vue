<template>
    <div class="container">
      <h3 class="title">🚫 Danh sách đen hồ sơ ứng viên ({{ candidates.length }})</h3>
        ...
        <table class="custom-table">
          <thead>
            <tr>
              ...
              <th class="text-center">📅 Ngày đánh dấu</th>
            </tr>
          </thead>
          <tbody>
            <tr v-for="(candidate, index) in filteredCandidates" :key="candidate.id">
              ...
              <td class="text-center">{{ candidate.markedDate }}</td>
            </tr>
          </tbody>
        </table>
      </div>
  ...
  export default {
    data() {
      return {
        ...
        selectedCandidates: [],
        candidates: [
          { id: 1, name: "HỒ SƠ XIN VIỆC", markedDate: "16/10/2024 10:04" },
          { id: 2, name: "Sơ Yếu Lý Lịch", markedDate: "16/10/2024 10:03" },
          { id: 3, name: "Ứng tuyển vị trí kế toán", markedDate: "16/10/2024 10:02" },
          { id: 4, name: "Kỹ sư cơ điện", markedDate: "16/10/2024 10:01" },
          { id: 5, name: "IT Manager", markedDate: "16/10/2024 09:59" },
        ],
        filteredCandidates: []
      };
    },
