<template>
  <div class="app-container">
    ...
    <el-table ref="tables" v-loading="loading" :data="list" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
      ...
      <el-table-column label="Login Time" align="center" prop="loginTime" sortable="custom" :sort-orders="['descending', 'ascending']" width="180">
        <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    /** 清空按钮操作 */
    handleClean() {
      this.$modal.confirm('Are you sure you want to clear all login log data items?').then(function() {
