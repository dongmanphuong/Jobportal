<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="72px">
      <el-form-item label="Tên" prop="configName">
        <el-input
          v-model="queryParams.configName"
          placeholder="Vui lòng nhập tên setting"
          clearable
          style="width: 240px"
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="Tham số" prop="configKey">
        <el-input
      ...
      <el-form-item label="Loại" prop="configType">
        <el-select v-model="queryParams.configType" placeholder="Hệ thống tích hợp sẵn" clearable>
          <el-option
    ...
    <el-table v-loading="loading" :data="configList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="Value" align="center" prop="configValue" :show-overflow-tooltip="true" />
      <el-table-column label="Type" align="center" prop="configType">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="Name" prop="configName">
          <el-input v-model="form.configName" placeholder="Please input config name" />
        </el-form-item>
        <el-form-item label="Key" prop="configKey">
          <el-input v-model="form.configKey" placeholder="Please input config key" />
        </el-form-item>
        <el-form-item label="Value" prop="configValue">
          <el-input v-model="form.configValue" placeholder="Please input config value" />
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        configKey: [
          { required: true, message: "Config key name cannot be empty", trigger: "blur" }
        ],
        configValue: [
          { required: true, message: "Config key value cannot be empty", trigger: "blur" }
        ]
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('Are you want to delete id = ' + configIds + ' ？').then(function() {
