  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch">
      ...
      <el-form-item label="Tình trạng" prop="status">
        <el-select v-model="queryParams.status" placeholder="Trạng thái menu" clearable>
          <el-option
    ...
    >
      ...
      <el-table-column prop="orderNum" label="Stt" width="60"></el-table-column>
      <el-table-column prop="perms" label="Perms" :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="component" label="Path" :show-overflow-tooltip="true"></el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="720px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="140px">
        <el-row>
          <el-col :span="24">
            <el-form-item label="Menu cha" prop="parentId">
              <treeselect
          ...
          <el-col :span="12">
            <el-form-item label="Stt" prop="orderNum">
          ...
          <el-col :span="12" v-if="form.menuType != 'F'">
            <el-form-item prop="isFrame">
              <span slot="label">
                <el-tooltip content="Nếu bạn chọn Liên kết ngoài, địa chỉ định tuyến cần bắt đầu bằng `http(s)://`" placement="top">
          ...
          <el-col :span="12" v-if="form.menuType != 'F'">
            <el-form-item prop="path">
              <span slot="label">
                <el-tooltip content="Địa chỉ tuyến đường cần truy cập, chẳng hạn như: `user`. Nếu địa chỉ mạng bên ngoài cần được truy cập nội bộ, nó phải bắt đầu bằng `http(s)://`" placement="top">
                <i class="el-icon-question"></i>
                </el-tooltip>
                Routing
              </span>
          ...
          <el-col :span="12" v-if="form.menuType == 'C'">
            <el-form-item prop="component">
              <span slot="label">
                <el-tooltip content="The component path to access, such as: `system/user/index`, which is in the `views` directory by default" placement="top">
                <i class="el-icon-question"></i>
                </el-tooltip>
                 Path
              </span>
          ...
          <el-col :span="12" v-if="form.menuType != 'M'">
            <el-form-item prop="perms">
              ...
              <span slot="label">
                <el-tooltip content="The permission characters defined in the controller, such as: @PreAuthorize(`@ss.hasPermi('system:user:list')`)" placement="top">
                <i class="el-icon-question"></i>
                </el-tooltip>
                Permission
              </span>
          ...
          <el-col :span="12" v-if="form.menuType == 'C'">
            <el-form-item prop="query">
              ...
              <span slot="label">
                <el-tooltip content='Access the default parameters of the route, such as: `{"id": 1, "name": "portal"}`' placement="top">
                <i class="el-icon-question"></i>
                </el-tooltip>
                Parameters
              </span>
          ...
          <el-col :span="12" v-if="form.menuType == 'C'">
            <el-form-item prop="isCache">
              <span slot="label">
                <el-tooltip content="If you select yes, it will be cached by `keep-alive`, and the `name` and address of the matching component must be consistent" placement="top">
                <i class="el-icon-question"></i>
                </el-tooltip>
                Cache
              </span>
          ...
          <el-col :span="12" v-if="form.menuType != 'F'">
            <el-form-item prop="visible">
              <span slot="label">
                <el-tooltip content="If you choose Hide, the route will not appear in the sidebar, but it can still be accessed." placement="top">
                <i class="el-icon-question"></i>
                </el-tooltip>
                Display Status
              </span>
  ...
  methods: {
    ...
    getTreeselect() {
      listMenu().then(response => {
        this.menuOptions = [];
        const menu = { menuId: 0, menuName: 'Main', children: [] };
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      this.$modal.confirm('Bạn có chắc chắn muốn xóa mục dữ liệu có tên "' + row.menuName + '" không?').then(function() {
