      ...
      <div>
        <div class="setting-drawer-content">
          <div class="setting-drawer-title">
            <h3 class="drawer-title">Cài đặt themes</h3>
          </div>
        ...
        <el-button size="small" type="primary" plain icon="el-icon-document-add" @click="saveSetting">Lưu cấu hình</el-button>
...
export default {
  ...
  methods: {
    ...
    saveSetting() {
      this.$modal.loading("Đang lưu vào máy tính cục bộ, vui lòng đợi...");
    ...
    resetSetting() {
      this.$modal.loading("Đang xóa bộ nhớ cache cài đặt và làm mới, vui lòng đợi...");
